...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Designentscheidung}: Der Raspberry Pi fragt Konfigurationsänderungen aktiv per Polling ab -- er betreibt keinen eigenen REST-Server. Das vereinfacht die Implementierung am Edge-Device erheblich. Der Nachteil (leichte Verzögerung bei Konfigurationsänderungen) ist für einen Prototyp akzeptabel.
\end{itemize}
