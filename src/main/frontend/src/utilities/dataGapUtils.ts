...
//t if gap of more than maxGapMs within interval, not covered by any measures
...
//indices where consecutive trend points further apart than thresholMult*median
